	...
	*/
	...
	private getLayoutData() {
		...
		return {
			...
			inputPartHorizontalPadding: this.options.inputPartHorizontalPadding ?? (this.options.renderStyle === 'compact' ? 16 : (this.options.fullWidthInput ? 0 : (this.options.isSessionsWindow ? 64 : 24))),
